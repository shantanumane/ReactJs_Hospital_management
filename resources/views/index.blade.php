@include('header');
                            ...
                            <div class="row table-cell ">
                                ...
                                <div class="col-lg-12 ">
                                    ...
                                    <div class="slider-content align-center ">
                                        ...
                                        <h1 class="slider-content-title " data-swiper-parallax="-100 ">Search Engine Optimization!
                                        </h1>
                                        <h5 class="slider-content-text c-gray " data-swiper-parallax="-200 ">Discover More About Our SEO Expertise!</h5>

                                        <div class="main-slider-btn-wrap " data-swiper-parallax="-300 ">

                                            <a href="http://localhost/psyber/public/04_service_detail_seo " class="btn btn-medium btn--dark btn-hover-shadow ">
                                ...
                                <div class="col-lg-5 table-cell ">
                                    <div class="slider-content ">
                                        <h3 class="slider-content-title " data-swiper-parallax="-100 ">
                                            <span class="c-dark ">Local SEO</span> is about bringing customers through your doors.</h3>
                                        <h5 class="slider-content-text " data-swiper-parallax="-200 ">New to local search and not sure where to start?
                                            This guide is the prefect introduction to local SEO for business and local search optimization.
                                        </h5>

                                        <div class="main-slider-btn-wrap " data-swiper-parallax="-300 ">

                                            <a href="http://localhost/psyber/public/05_service_details_localseo" class="btn btn-medium btn--dark btn-hover-shadow ">
                                                <span class="text ">learn more</span>
                                                <span class="semicircle "></span>
                                            </a>

                                            <a href="http://localhost/psyber/public/05_service_details_localseo " class="btn btn-small btn--primary " data-swiper-parallax="-300 ">
                            ...
                            <div class="row table-cell ">
                                <div class="col-lg-6 table-cell ">
                                    ...
                                    <div class="slider-content ">
                                        ...
                                        <h3 class="h1 slider-content-title c-dark " data-swiper-parallax="-100 ">Social Media Marketing Services
                                        </h3>

                                        <h5 class="slider-content-text " data-swiper-parallax="-200 ">An effective social strategy can help you grow your business, maintain your social presence and engage with the audience.
                                        </h5>

                                        <div class="main-slider-btn-wrap " data-swiper-parallax="-300 ">

                                            <a href="http://localhost/psyber/public/06_service_detail " class="btn btn-medium btn--dark btn-hover-shadow ">
                                                <span class="text ">learn more</span>
                                                <span class="semicircle "></span>
                                            </a>

                                            <a href="http://localhost/psyber/public/06_service_detail" class="btn btn-medium btn-border ">
                        ...
                        <div class="container table ">
                            <div class="row table-cell ">
                                ...
                                <div class="col-lg-12 ">
                                    ...
                                    <div class="slider-content align-center ">
                                        <h3 class="h1 slider-content-title c-dark " data-swiper-parallax="-100 ">Email Marketing
                                        </h3>
                                        <h5 class="slider-content-text " data-swiper-parallax="-200 ">We create tailored marketing campaigns for each segment of your audience to help advertise products and services in efforts to efficiently and effectively engage new customers.
                                        </h5>

                                        <div class="main-slider-btn-wrap " data-swiper-parallax="-300 ">

                                            <a href="http://localhost/psyber/public/07_service_email_marketing " class="btn btn-medium btn--dark btn-hover-shadow ">
                                                <span class="text ">learn more</span>
                                                <span class="semicircle "></span>
                                            </a>
                            ...
                            <div class="row table-cell ">
                                ...
                                <div class="col-lg-6 table-cell ">
                                    <div class="slider-content ">
                                        ...
                                        <h3 class="h1 slider-content-title c-dark " data-swiper-parallax="-100 ">Pay Per Click (PPC) Management
                                        </h3>

                                        <h5 class="slider-content-text " data-swiper-parallax="-200 ">Pay Per Click has an instant impact and gives your brand a much larger reach and exposure as a result of first page exposure on major search engines.
                                        </h5>

                                        <div class="main-slider-btn-wrap " data-swiper-parallax="-300 ">

                                            <a href="http://localhost/psyber/public/08_service_ppc_management " class="btn btn-medium btn--dark btn-hover-shadow ">
                                                <span class="text ">learn more</span>
                                                <span class="semicircle "></span>
                                            </a>

                                            <a href="http://localhost/psyber/public/08_service_ppc_management " class="btn btn-medium btn-border btn-hover-shadow ">
                                                <span class="text ">GET STARTED</span>
                                                <span class="semicircle "></span>
                                            </a>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 ">
                    <div class="info-box--standard " data-mh="info-boxes ">
                        ...
                        <div class="info-box-content ">
                            ...
                            <p class="text ">Optimisation of SEO Elements with On-Page editing which makes site optimum for local searches.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 ">
                    <div class="info-box--standard " data-mh="info-boxes ">
                        ...
                        <div class="info-box-content ">
                            ...
                            <p class="text ">Google Maps SEO and advertising services are designed to maximize local search visibility.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 ">
                    <div class="info-box--standard " data-mh="info-boxes ">
                        ...
                        <div class="info-box-content ">
                            ...
                            <p class="text ">Link building is when you get other websites or blogs to link to your site's page in order to improve your search engine rankings.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 ">
                    <div class="info-box--standard " data-mh="info-boxes ">
                        ...
                        <div class="info-box-content ">
                            ...
                            <p class="text ">Over 8 billion keyword ideas, long-tails, phrase matches, related words & more. 140+ regional databases.
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 ">
                    <div class="info-box--standard " data-mh="info-boxes ">
                        ...
                        <div class="info-box-content ">
                            ...
                            <p class="text ">Learning and understanding about your business, and applying a sound process of strategy, user experience, design execution, programming, and marketing to form a successful online business presence.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 ">
                    <div class="info-box--standard " data-mh="info-boxes ">
                        ...
                        <div class="info-box-content ">
                            ...
                            <p class="text ">Dedicated Service to Custom Design and Code of Email Marketing Newsletter Templates.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="offers ">
                        <div class="row ">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12 ">
                                <div class="heading ">
                                    <h4 class="h1 heading-title ">We Offer a Full Range of Digital Marketing Services!</h4>
                        ...
                        <div class="row ">
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
                                <div class="heading ">
                                    <p class="heading-text ">Our team develops effective content strategies for forward thinking companies.
                                    </p>
                                </div>

                                <ul class="list list--secondary ">
                                    <li>
                                        <i class="seoicon-check "></i> We can help you build a sustainable, meaningful relationship with your clients by engaging them with your brand using social media.
                                    </li>
                                    <li>
                                        <i class="seoicon-check "></i> We work in areas as diverse as search engine optimization, social media marketing, email marketing and digital marketing.
                                    </li>
                                    <li>
                                        <i class="seoicon-check "></i> We pursue relationships based on transparency, persistence, mutual trust, and integrity with our employees, customers and other business partners.
                                    </li>
                                    <!-- <li>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 no-padding ">
                        <!-- <div class="video theme-module "> -->
                            <!-- <div class="video-thumb "> -->
                                ...
                                <iframe width="650" height="500" src="https://www.youtube.com/embed/vZeiyyws8SI" frameborder="5" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                <!-- <a href="https://www.youtube.com/watch?v=vZeiyyws8SI " class="video-control js-popup-iframe ">
                    ...
                    <div class="col-lg-4 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-12 col-xs-12 no-padding ">
                        <div class="content theme-module centered-on-mobile medium-padding100 ">
                            <div class="heading ">
                                ...
                                <p class="heading-text ">We work with you to build a strategy to achieve your business goals
                                </p>
                            </div>
                            <a href="# " class="btn btn-medium btn--secondary ">
                    ...
                    <div class="container ">
                        <div class="row ">
                            <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12 ">
                                <div class="heading align-center ">
                                    ...
                                    <p class="heading-text ">Our startup bundle offers a range of consulting and marketing services for startup's.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                                <div class="info-box--standard-centered ">
                                    ...
                                    <div class="info-box-content ">
                                        ...
                                        <p class="text ">Understanding your needs and campaign goals.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                                <div class="info-box--standard-centered ">
                                    ...
                                    <div class="info-box-content ">
                                        ...
                                        <p class="text ">Choosing the right content & channels as per the audience.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                                <div class="info-box--standard-centered ">
                                    ...
                                    <div class="info-box-content ">
                                        ...
                                        <p class="text ">Building the right infrastructure to nurture leads.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                                <div class="info-box--standard-centered ">
                                    ...
                                    <div class="info-box-content ">
                                        ...
                                        <p class="text ">Understanding what works and building forward.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row align-center ">
                            <div class="btn-block ">
                                ...
                                <a href="# " class="btn btn-medium btn--breez ">
                                    <span class="text ">Get Started!</span>
                                    <span class="semicircle "></span>
                                </a>
                            </div>
                    ...
                    <div class="row ">
                        <div class="counters ">
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 ">
                                <div class="counter-item ">
                                    <div class="counter-numbers counter ">
                                        <span style="font-size: 90px;" data-speed="2000 " data-refresh-interval="3 " data-to="96 " data-from="2 ">96%</span>
                                        <div class="units "></div>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 ">
                                <div class="counter-item ">
                                    <div class="counter-numbers counter ">
                                        <span style="font-size: 90px;" data-speed="2000 " data-refresh-interval="3 " data-to="10 " data-from="0 ">10</span>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 ">
                                <div class="counter-item ">
                                    <div class="counter-numbers counter ">
                                        <span style="font-size: 90px;" data-speed="2000 " data-refresh-interval="3 " data-to="70 " data-from="2 ">70+</span>
                                        <div class="units "></div>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 ">
                                <div class="counter-item ">
                                    <div class="counter-numbers counter ">
                                        <span style="font-size: 90px;" data-speed="2000 " data-refresh-interval="3 " data-to="690 " data-from="400 ">690+</span>
                                        <div class="units "></div>
                                    </div>
                ...
                <div class="recent-case align-center ">
                    ...
                    <div class="col-lg-12 ">
                        ...
                        <div class="row ">
                            <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12 ">
                                <div class="heading align-center ">
                                    <h4 class="h1 heading-title ">Marketing Stages</h4>
                                    <div class="heading-line ">
                                        <span class="short-line "></span>
                                        <span class="long-line "></span>
                                    </div>
                    ...
                    <div class="container ">
                        <div class="row ">
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                                <div class="heading ">
                                    <h4 class="h1 heading-title ">Happy Clients About Us</h4>
                                    <div class="heading-line ">
                                ...
                                <div class="signature js-animate-icon ">
									...
									<path fill="none " stroke="#2f2c2c " stroke-width="1.4 "
										  d="M24.78 42.5C11.28 41.06.96 36 1.16 26.86 1.62 11.6 16.76 3.6 28.13 3.25c5.44-.16 9.8 2.38 10.2 5.8.86 7.66-19.23 15.62-19.23 15.62s17.86-6.57 24.66 2.2c2.8 3.6-11.8 10.65-11.8 10.65s-8.8 3.35-7.65-.24c1.78-5.52 16.8-10.1 18.42-10.3 3.17-.4
                            7.1-.4 8 .12 1.33.78-1.7 4.14-.94 4.86.76.72 3.82-2.55 3.94-1.97.12.57-.64 2.63.58 3 1.2.38 2.3-1.1 4.28-1.5 1.97-.4 1.83-.44 3.6-.12 1.76.32 2.1.64 3.47 1.4 1.36.74.86 2.22 1.96 1.6 1.1-.6 1.43-4.16 2.44-4.04 1.02.1.03 5.38 1.63
                            4.5 1.6-.85 4.74-7.97 4.74-7.97s-.82 4.04 0 3.93c3.14-.4 8.12-2.57 14.48-3.36 6.37-.78 8.67-.35 11 .24 1.92.48 2.67 2.3 2.67 2.3 "
                                        ...
                                        <div class="swiper-wrapper ">
                                            <div class="testimonial-slider-item swiper-slide ">
                                                <div class="testimonial-content ">
                                                    <p class="text " data-swiper-parallax="-200 ">Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim.
                                                    </p>
                        ...
                        <div class="row ">
                            <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12 ">
                                <div class="heading align-center ">
                                    ...
                                    <p class="heading-text ">Simple / Clear / Affordable / Effective
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="pricing-tables-wrap ">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 ">
                                    ...
                                    <div class="pricing-tables-item ">
                                        ...
                                        <h5 class="pricing-title ">Stage 1: Google Friendly Website</h5>
                                        ...
                                        <ul class="pricing-tables-position ">
                                            ...
                                            <li class="position-item ">
                                                - SEO (Search Engine Optimization) Friendly Website
                                            </li>
                                            <li class="position-item ">
                                            ...
                                            <li class="position-item ">
                                                - ALL PREMIUM PLUGINS FOR SEO + WHATSAPP + FACEBOOK CHAT
                                            </li>
                                        </ul>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 ">
                                    <div class="pricing-tables-item ">
                                        ...
                                        <a href="# " class="pricing-title ">Stage 2 : Social Media Marketing & SEO</a>
                                        <ul class="pricing-tables-position ">
                                            <li class="position-item ">
                                                - 8 Unique Social Updates
                                            ...
                                            <li class="position-item ">
                                                - Youtube Channel Management & Subscriber Growth
                                            </li>
                                            <li class="position-item ">
                                                - New Page Likes & Interactions with Page Posts - Every Month
                                            </li>
                                            <li class="position-item ">
                                                - Regular Posting & Page Management
                                            </li>
                                            <li class="position-item ">
                                                - 4 Unique Related Blogs
                                            </li>
                                            <li class="position-item ">
                                                - Website On-page SEO Setup
                                            </li>
                                            <li class="position-item ">
                                            ...
                                            <li class="position-item ">
                                                - Google Keyword Targeting {Needs Adwords Upgrade}
                                            </li>
                                            <li class="position-item ">
                                                - Basic Boosting to get new likes
                                            </li>
                                            <li class="position-item ">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 ">
                                    <div class="pricing-tables-item ">
                                        ...
                                        <a href="# " class="pricing-title ">Stage 3 : Launch Mobile Application</a>
                                        <ul class="pricing-tables-position ">
                                            <li class="position-item ">
                                                Core objective for this will be to build user database for marketing



                                            </li>
                                            <li class="position-item ">
                                                - For each store to promote itself
                                            </li>
                                            <li class="position-item ">
                                                - Push location specific offers coupons
                                            </li>
                                            <li class="position-item ">
                                                - Build user database and remarket to them and their FB friends with different campaigns
                                            </li>
                                        </ul>
                        ...
                        <div class="swiper-container pagination-bottom " data-show-items="4 ">
                            ...
                            <div class="swiper-wrapper ">
                                ...
                                <div class="swiper-slide client-item ">
                                    <a href="http://localhost/psyber/public/09_our_clients" class="client-image ">
                ...
                <div class="info ">
                    <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 ">
                        <div class="heading ">
                            ...
                            <p class="heading-text ">Qolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibham liber tempor cum soluta nobis eleifend option congue nihil uarta decima et quinta. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit
                                lobortis nisl ut aliquip ex ea commodo consequat eleifend option nihil. Investigationes demonstraverunt lectores legere me lius quod ii legunt saepius parum claram.
                            </p>
                        </div>
            ...
            <div class="row ">
                <div class="contacts ">
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 ">
                        <div class="contacts-item ">
                            <div class="icon js-animate-icon ">
                                <svg enable-background="new 0 0 64 64 " version="1.1 " viewBox="0 0 64 64 " xml:space="preserve " xmlns="http://www.w3.org/2000/svg "><path d=" M45.1,44.2C42.9,42,39.6,40,37,42.6c-1.8,1.8-2.6,3.9-2.6,3.9s-4.3,2.3-11.7-5.2s-5.2-11.7-5.2-11.7s2.1-0.8,3.9-2.6
                            c2.6-2.6,0.6-5.9-1.7-8.1c-2.7-2.7-6.2-4.9-8.2-2.9c-3.7,3.7-4.4,8.4-4.4,8.4S9,35.5,18.7,45.3s20.9,11.6,20.9,11.6s4.7-0.7,8.4-4.4 C50,50.4,47.8,46.9,45.1,44.2z " fill="none " stroke="#fcb03b " stroke-linecap="round
                            " stroke-linejoin="round " stroke-miterlimit="10 " stroke-width="2 "/><path d=" M18.4,12.2C22.2,9.5,26.9,8,32,8c13.3,0,24,10.8,24,24c0,4-1.3,9-4.4,12.2 " fill="none " stroke="#fcb03b " stroke-linecap="round " stroke-linejoin="round
                            " stroke-miterlimit="10 " stroke-width="2 "/><path d=" M27.3,55.6c-9.8-1.9-17.5-9.8-19.1-19.7 " fill="none " stroke="#fcb03b " stroke-linecap="round " stroke-linejoin="round " stroke-miterlimit="10 " stroke-width="2 "/><path d=" M30,21c0,0,4.4,0,5.2,0c1.2,0,1.8,0.2,1.8,1.1s0,0.7,0,1.3c0,0.6,0,1.4-1.6,2.5c-2.3,1.6-5.6,3.8-5.6,5.1c0,1.6,0.7,2,1.8,2
                            s5.3,0,5.3,0 " fill="none " stroke="#fcb03b " stroke-linecap="round " stroke-linejoin="round " stroke-miterlimit="10 " stroke-width="2 "/><path d=" M40,21c0,0,0,2.8,0,3.8S39.9,27,41.5,27c1.6,0,4.5,0,4.5,0v-6.1V33 " fill="none
                            " stroke="#fcb03b " stroke-linecap="round " stroke-linejoin="round " stroke-miterlimit="10 " stroke-width="2 "/></svg>
                            </div>
                            <div class="content ">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 ">
                        <div class="contacts-item ">
                            <div class="icon js-animate-icon ">
                                <svg enable-background="new 0 0 64 64 " version="1.1 " viewBox="0 0 64 64 " xml:space="preserve " xmlns="http://www.w3.org/2000/svg "><polyline fill="none " points=" 54,17 32,36 10,17 " stroke="#f15b26
                            " stroke-linecap="round " stroke-linejoin="round " stroke-miterlimit="10 " stroke-width="2 "/><line fill="none " stroke="#f15b26 " stroke-linecap="round " stroke-linejoin="round " stroke-miterlimit="10 " stroke-width="2 " x1="10.9 " x2="26
                            " y1="48 " y2="36 "/><path d=" M32.7,49H13c-2.2,0-4-1.8-4-4V19c0-2.2,1.8-4,4-4h38c2.2,0,4,1.8,4,4v15.5 " fill="none " stroke="#f15b26 " stroke-linecap="round " stroke-linejoin="round " stroke-miterlimit="10 " stroke-width="2
                            "/><circle cx="44.9 " cy="43.1 " fill="none " r="10.1 " stroke="#f15b26 " stroke-linecap="round " stroke-linejoin="round " stroke-miterlimit="10 " stroke-width="2 "/><path d=" M44,41.4c0,0-1.3,3.4-0.9,5.1c0.4,1.7,2.6,2.1,3.7,1.1 " fill="none
                            " stroke="#f15b26 " stroke-linecap="round " stroke-linejoin="round " stroke-miterlimit="10 " stroke-width="2 "/><g><circle cx="45.4 " cy="38.3 " fill="#DCE9EE " r="0.9 "/><path d="M45.4,37.3c-0.5,0-0.9,0.4-0.9,0.9c0,0.5,0.4,0.9,0.9,0.9s0.9-0.4,0.9-0.9C46.4,37.8,46,37.3,45.4,37.3
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 ">
                        <div class="contacts-item ">
                            <div class="icon js-animate-icon ">
                                <svg enable-background="new 0 0 64 64 " version="1.1 " viewBox="0 0 64 64 " xml:space="preserve " xmlns="http://www.w3.org/2000/svg "><polygon fill="none " points=" 38.7,36.4 56,32 38.7,27.6 42,22 36.4,25.3 32,8 27.6,25.3
                            22,22 25.3,27.6 8,32 25.3,36.4 22,42 27.6,38.7 32,56 36.4,38.7 42,42 " stroke="#3cb878 " stroke-linecap="round " stroke-linejoin="round " stroke-miterlimit="10 " stroke-width="2 "></polygon><circle cx="32 " cy="32 " fill="none
                            " r="4 " stroke="#3cb878 " stroke-linecap="round " stroke-linejoin="round " stroke-miterlimit="10 " stroke-width="2 "></circle><path d=" M26.1,53.2c-7.9-2.2-13.9-8.6-15.6-16.7 " fill="none " stroke="#3cb878 " stroke-linecap="round
                            " stroke-linejoin="round " stroke-miterlimit="10 " stroke-width="2 "></path><path d=" M53.5,36.9c-1.8,8.1-8.2,14.6-16.3,16.5 " fill="none " stroke="#3cb878 " stroke-linecap="round " stroke-linejoin="round " stroke-miterlimit="10 " stroke-width="2
                            "></path><path d=" M36.9,10.5c8.2,1.9,14.7,8.3,16.6,16.6 " fill="none " stroke="#3cb878 " stroke-linecap="round " stroke-linejoin="round " stroke-miterlimit="10 " stroke-width="2 "></path><path d=" M10.5,27.1c1.9-8.2,8.3-14.6,16.4-16.5 " fill="none
                            " stroke="#3cb878 " stroke-linecap="round " stroke-linejoin="round " stroke-miterlimit="10 " stroke-width="2 "></path></svg>
                            </div>
                            <div class="content ">
    ...
    <div class="window-popup ">
        ...
        <div class="sign-in-popup ">
            <h5 class="title ">Register to Psyber</h5>
	...
	<symbol id="arrow-left " viewBox="122.9 388.2 184.3 85 ">
		<path d="M124.1,431.3c0.1,2,1,3.8,2.4,5.2c0,0,0.1,0.1,0.1,0.1l34.1,34.1c1.6,1.6,3.7,2.5,5.9,2.5s4.3-0.9,5.9-2.4 c1.6-1.6,2.4-3.7,2.4-5.9s-0.9-3.9-2.4-5.5l-19.9-19.5h11.1c1.5,0,2.7-1.5,2.7-3c0-1.5-1.2-3-2.7-3h-17.6c-1.1,0-2.1,0.6-2.5,1.6 c-0.4,1-0.2,2.1,0.6,2.9l24.4,24.4c0.6,0.6,0.9,1.3,0.9,2.1s-0.3,1.6-0.9,2.1c-0.6,0.6-1.3,0.9-2.1,0.9s-1.6-0.3-2.1-0.9
                            l-34.2-34.2c0,0,0,0,0,0c-0.6-0.6-0.8-1.4-0.9-1.9c0,0,0,0,0,0c0-0.2,0-0.4,0-0.6c0.1-0.6,0.3-1.1,0.7-1.6c0-0.1,0.1-0.1,0.2-0.2 l34.1-34.1c0.6-0.6,1.3-0.9,2.1-0.9s1.6,0.3,2.1,0.9c0.6,0.6,0.9,1.3,0.9,2.1s-0.3,1.6-0.9,2.1l-24.4,24.4c-0.8,0.8-1,2-0.6,3
                            c0.4,1,1.4,1.7,2.5,1.7h125.7c1.5,0,2.7-1,2.7-2.5c0-1.5-1.2-2.5-2.7-2.5H152.6l19.9-20.1c1.6-1.6,2.4-3.8,2.4-6s-0.9-4.4-2.4-6 c-1.6-1.6-3.7-2.5-5.9-2.5s-4.3,0.9-5.9,2.4l-34.1,34.1c-0.2,0.2-0.3,0.3-0.5,0.5c-1.1,1.2-1.8,2.8-2,4.4 C124.1,430.2,124.1,430.8,124.1,431.3C124.1,431.3,124.1,431.3,124.1,431.3z "></path>
	...
	<symbol id="arrow-right " viewBox="122.9 388.2 184.3 85 ">
		<path d="M305.9,430.2c-0.1-2-1-3.8-2.4-5.2c0,0-0.1-0.1-0.1-0.1l-34.1-34.1c-1.6-1.6-3.7-2.5-5.9-2.5c-2.2,0-4.3,0.9-5.9,2.4 c-1.6,1.6-2.4,3.7-2.4,5.9s0.9,4.1,2.4,5.7l19.9,19.6h-11.1c-1.5,0-2.7,1.5-2.7,3c0,1.5,1.2,3,2.7,3h17.6c1.1,0,2.1-0.7,2.5-1.7 c0.4-1,0.2-2.2-0.6-2.9l-24.4-24.5c-0.6-0.6-0.9-1.3-0.9-2.1s0.3-1.6,0.9-2.1c0.6-0.6,1.3-0.9,2.1-0.9c0.8,0,1.6,0.3,2.1,0.9
                            l34.2,34.2c0,0,0,0,0,0c0.6,0.6,0.8,1.4,0.9,1.9c0,0,0,0,0,0c0,0.2,0,0.4,0,0.6c-0.1,0.6-0.3,1.1-0.7,1.6c0,0.1-0.1,0.1-0.2,0.2 l-34.1,34.1c-0.6,0.6-1.3,0.9-2.1,0.9s-1.6-0.3-2.1-0.9c-0.6-0.6-0.9-1.3-0.9-2.1s0.3-1.6,0.9-2.1l24.4-24.4c0.8-0.8,1-1.9,0.6-2.9
                            c-0.4-1-1.4-1.6-2.5-1.6H158.1c-1.5,0-2.7,1-2.7,2.5c0,1.5,1.2,2.5,2.7,2.5h119.3l-19.9,20c-1.6,1.6-2.4,3.7-2.4,6s0.9,4.4,2.4,5.9 c1.6,1.6,3.7,2.5,5.9,2.5s4.3-0.9,5.9-2.4l34.1-34.1c0.2-0.2,0.3-0.3,0.5-0.5c1.1-1.2,1.8-2.8,2-4.4 C305.9,431.3,305.9,430.8,305.9,430.2C305.9,430.2,305.9,430.2,305.9,430.2z "></path>
	...
	<symbol id="to-top " viewBox="0 0 32 32 ">
		<path d="M17,22 L25.0005601,22 C27.7616745,22 30,19.7558048 30,17 C30,14.9035809 28.7132907,13.1085075 26.8828633,12.3655101 L26.8828633,12.3655101 C26.3600217,9.87224935 24.1486546,8 21.5,8 C20.6371017,8 19.8206159,8.19871575 19.0938083,8.55288165
                            C17.8911816,6.43144875 15.6127573,5 13,5 C9.13400656,5 6,8.13400656 6,12 C6,12.1381509 6.00400207,12.275367 6.01189661,12.4115388 L6.01189661,12.4115388 C4.23965876,13.1816085 3,14.9491311 3,17 C3,19.7614237 5.23249418,22 7.99943992,22
                            L16,22 L16,16 L12.75,19.25 L12,18.5 L16.5,14 L21,18.5 L20.25,19.25 L17,16 L17,22 L17,22 Z M16,22 L16,27 L17,27 L17,22 L16,22 L16,22 Z " id="cloud-upload "></path>
	</symbol>
