                ...
                <div class="info">
                    <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                        <div class="heading">
                            ...
                            <p class="heading-text">Psyber technologies is an full service Interactive media agency (Social Media, Digital Marketing, Branding)​, a tight-knit team of creators, doers, organizers and overall talented souls. We are lucky enough to create something
                                beautiful almost every other day, build brands and design websites for talented people from all around the world. Life is good! We love our work and we are sure you will too!
                            </p>
                        </div>

                        <div class="socials">
                            <a href="https://www.facebook.com/PSYBERINC" class="social__item">
                                <img loading="lazy" src="{{asset(('/svg/circle-facebook.svg'))}}" alt="facebook">
                            </a>
                            <!-- <a href="https://goo.gl/maps/8PGNkQTeA8DHheme8" class="social__item">
                                <img loading="lazy" src="{{asset(('/svg/twitter.svg'))}}" alt="twitter">
                            </a> -->
                            <a href="https://goo.gl/maps/8PGNkQTeA8DHheme8" class="social__item">
                                <img loading="lazy" src="{{asset(('/svg/google.svg'))}}" alt="google">
                            </a>
                            <a href="https://www.youtube.com/channel/UCK2bM1JEJEKEKjNuMKK_RUg" class="social__item">
                                <img loading="lazy" src="{{asset(('/svg/youtube.svg'))}}" alt="youtube">
                            </a>
                            <!-- <a href="" class="social__item">
                                <img loading="lazy" src="{{asset(('/svg/rss.svg'))}}" alt="rss">
                            </a> -->
                        </div>
                    </div>
                ...
                <div class="contacts">
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        <div class="contacts-item">
                            ...
                            <div class="content">
                                <a href="#" class="title">+91 99300 90487
									</a>
                                <p class="sub-title">24x7 SALES TEAM</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        <div class="contacts-item">
                            ...
                            <div class="content">
                                <a href="#" class="title">antriksh@psyber.co</a>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        <div class="contacts-item">
                            ...
                            <div class="content">
                                <a href="#" class="title">Mumbai - India
									</a>
                                <p class="sub-title">B-104, Udaygiri, Evershine nagar, Malad (w)</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <center> <span>
                      Copyright © 2021 All Rights Reserved by <a href="https://psyber.co/">Psyber Inc</a>
                    </span></center>
    ...
    <script src="{{asset(('/js/js-plugins/jquery.drawsvg.js'))}}"></script>
    <script src="{{asset(('/js/js-plugins/jquery-countTo.js'))}}"></script>
    <script src="{{asset(('/js/js-plugins/jquery.mousewheel.js'))}}"></script>
    <script src="{{asset(('/js/js-plugins/jquery.mCustomScrollbar.js'))}}"></script>
    ...
    <script src="{{asset(('/js/js-plugins/jquery-circle-progress.js'))}}"></script>
    ...
    <script src="{{asset(('/js/js-plugins/fastClick.js'))}}"></script>
    <script src="{{asset(('/js/js-plugins/form-actions.js'))}}"></script>
    <script src="{{asset(('/js/js-plugins/velocity.js'))}}"></script>
    <script src="{{asset(('/js/js-plugins/time-line.js'))}}"></script>
    <script src="{{asset(('/js/js-plugins/ScrollMagic.min.js'))}}"></script>
    <script src="{{asset(('/js/js-plugins/animation.velocity.min.js'))}}"></script>
    <script src="{{asset(('/js/js-plugins/ajax-pagination.js'))}}"></script>
    <script src="{{asset(('/js/js-plugins/donut-chart.js'))}}"></script>
    <script src="{{asset(('/js/js-plugins/isotope.pkgd.min.js'))}}"></script>
    <script src="{{asset(('/js/js-plugins/photo-gallery.js'))}}"></script>
