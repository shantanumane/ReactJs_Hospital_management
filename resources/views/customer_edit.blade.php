    ...
    if($query_run)
            {
                ...
                // header('Location:');
                return redirect()->route(' http://localhost/psyber/public/customers','id=3' );
...
<!-- Mirrored from gambolthemes.net/html-items/gambo_admin/customer_edit.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Feb 2021 14:38:27 GMT -->
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-light bg-clr">
        ...
        <a href="../gambo_supermarket_demo/index.html" class="frnt-link"><i
...
<input type="text" class="form-control" value="Joginder Singh" placeholder="Enter Full Name">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="e_id" value=<?php echo $row['id']; ?>
                                                    placeholder="Enter ID">
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">Username*</label>
                                                <input type="text" class="form-control" name="e_name" value=<?php echo $row['name']; ?>
                                                    placeholder="Enter Username">
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">Email*</label>
                                                <input type="email" class="form-control" name="e_email" value="<?php echo $row['email']; ?>"
...
<textarea class="text-control" value="Ludhiana, Punjab" placeholder="Enter Description"></textarea>
                                        ...
                                        <button class="save-btn hover-btn" name="sub_btn" type="submit"  >Save Changes</button>
                                        </form>
                                    </div>
                                </div>
                                <?php
